                ...
                <GlassCard key={os} className="p-6 hover:bg-white/5 transition-colors cursor-pointer group">
                  ...
                  {os === 'linux' ? (
                    ...
                    <div className="flex flex-col gap-2 mt-2">
                      <a href="https://apps.microsoft.com/detail/9p888nv4qrls?referrer=appbadge&mode=full" target="_blank" rel="noreferrer" className="block hover:scale-[1.02] transition-transform origin-left w-fit">
